...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-blue text-black navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/best-bakery-in-town-logo-design-template-36cc6d8197e6991a1a6e9866e4e64919_screen.jpg?ts=1602149905"
                width="110"
                height="32"
                alt="Tabler"
